...
public class ReflectionHelper {
	...
	public static void setFieldValueBySetter(Object object, Field field, Object value) {
		try {
			...
			while (it.hasNext()) {
				Method m = it.next();
				if (!Modifier.isPublic(m.getModifiers()) || m.getParameterTypes().length != 1 || (value != null && !m.getParameterTypes()[0].isAssignableFrom(value.getClass()))
	 ...
	 * @throws RuntimeException of type IllegalAccessException, IllegalArgumentException
	 */
