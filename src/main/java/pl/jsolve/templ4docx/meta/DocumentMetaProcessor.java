...
public class DocumentMetaProcessor {
	 ...
	 * @param keysHolder KeysHolder
	 * @param variablePattern VariablePattern
	 */
	protected void moveVariablesToSeparateRun(XWPFParagraph paragraph, KeysHolder keysHolder, VariablePattern variablePattern) {
		...
		for (XWPFRun run : runs) {
			...
			for (String varName : varNames) {
				if (keysHolder.containsKeyByName(varName)) {
					lastProcessedRunIndex = splitRunByVariable(paragraph, lastProcessedRun, lastProcessedRunIndex, varName);
		...
		if (!newParagraphText.equals(paragraphText))
			throw new IllegalStateException(String.format("Paragraph text is changed from \"%s\" to \"%s\"!", paragraphText, newParagraphText));
	}
	 ...
	 * @param variablePattern VariablePattern
	 */
	protected void markVariablesByBookmarks(XWPFParagraph paragraph, KeysHolder keysHolder, VariablePattern variablePattern) {
		String paragraphText = paragraph.getText();
	 ...
	 * @param run XWPFRun
	 * @param keysHolder KeysHolder
	 * @return list of VariableBookmark
	 */
	 ...
	 * @param paragraph XWPFParagraph
	 * @param run XWPFRun
	 * @param bookmarkStart CTBookmark
	 * @param bookmarkEnd CTMarkupRange
	 */
	protected void alignNodes(XWPFParagraph paragraph, XWPFRun run, CTBookmark bookmarkStart, CTMarkupRange bookmarkEnd) {
	 ...
	 *
	 * @param paragraph XWPFParagraph
	 * @param varBookmark VariableBookmark
	 * @param keysHolder KeysHolder
	 */
