...
public class DocumentCleaner {
	...
	public void clean(Docx docx, Variables variables, VariablePattern variablePattern) {
		...
		// Clean footnotes
		for (XWPFFootnote footnote : docx.getXWPFDocument().getFootnotes()) {
					...
					if (notRecognizedVariableStartIndex != -1) {
						...
						if (!suffixIndexesOf.isEmpty()) {
							...
							if (executeResult) {
								...
								textFromStartRun = StringUtils.replace(textFromStartRun, notRecognizedPrefix, notRecognizedVariable);
